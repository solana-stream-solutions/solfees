  ...
  return (
    <div className="flex flex-nowrap justify-between w-full">
      <div className="flex flex-nowrap items-center justify-start gap-1">
        <div className="text-[#002033]/60 text-xs font-normal font-['Inter'] leading-none">
          Powered by
        </div>
      ...
      <div className="justify-start items-center gap-3 flex">
        ...
        <a
          className="text-[#002033]/60 text-xs font-normal font-['Inter'] leading-none"
          href="https://github.com/solana-stream-solutions/"
          target="_blank"
        >
          Developed by Solana Stream Solutions
        </a>
      </div>
    </div>
  );
